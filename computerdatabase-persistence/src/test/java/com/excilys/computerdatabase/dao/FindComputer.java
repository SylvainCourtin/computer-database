...
public class FindComputer {
	...
	public void testFindLike() {
		try {
			assertThat(computerDao.add(new Computer("LEGRAND v1 la version 1", DateUtil.stringToDate("null"), DateUtil.stringToDate("null"), null)), 
					not(equalTo(-1L)));
			
			assertThat(computerDao.add(new Computer("LEGRAND___ v2", DateUtil.stringToDate("null"), DateUtil.stringToDate("null"), null)), 
					not(equalTo(-1L)));
			
			assertThat(computerDao.add(new Computer("___LEGRAND v3", DateUtil.stringToDate("null"), DateUtil.stringToDate("null"), null)), 
					not(equalTo(-1L)));
			
			assertThat(computerDao.add(new Computer("LEGRAND___v4", DateUtil.stringToDate("null"), DateUtil.stringToDate("null"), null)), 
					not(equalTo(-1L)));
