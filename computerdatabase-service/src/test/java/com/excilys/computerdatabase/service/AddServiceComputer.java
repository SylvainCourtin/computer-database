...
public class AddServiceComputer {
	...
	{
		try {
			assertThat(serviceComputer.addComputer(new Computer("ilMarche", DateUtil.stringToDate("null"), DateUtil.stringToDate("null"), null)), 
					not(equalTo(-1L)));
			
			assertThat(serviceComputer.addComputer(new Computer("ilMarcheDate2", DateUtil.stringToDate("16-01-2000"), DateUtil.stringToDate("null"), null)), 
					not(equalTo(-1L)));
			
			assertThat(serviceComputer.addComputer(new Computer("ilMarcheDate3", DateUtil.stringToDate("16-01-2000"), DateUtil.stringToDate("16-01-2001"), null)), 
					not(equalTo(-1L)));
			
			assertThat(serviceComputer.addComputer(new Computer("ilMarcheDate4", DateUtil.stringToDate("null"), DateUtil.stringToDate("null"), serviceCompany.getCompany(1).get())), 
					not(equalTo(-1L)));
	...
	{
		try {
			assertThat(serviceComputer.addComputer(new Computer("failCompany", DateUtil.stringToDate("null"), DateUtil.stringToDate("null"), new Company(1000, "marchepas"))), 
					equalTo(-1L));
