...
public class MyConstants {
	...
	public static final String SQL_QUERY_COMPUTER_SELECT_LEFT_JOIN_COMPANY = "SELECT * FROM computer LEFT JOIN company ON company.id = computer.company_id WHERE company_id=?;";
