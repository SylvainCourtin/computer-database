...
public class MyConstants {
	...
	public static final String SQL_QUERY_COMPUTER_SELECT_LIKE_LEFT_JOIN_COMPANY_LIMIT = "SELECT * FROM computer LEFT JOIN company ON company.id = computer.company_id LIMIT ? OFFSET ? ;";
